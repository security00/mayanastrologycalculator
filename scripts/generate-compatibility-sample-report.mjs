...
const order = {
  report_type: 'mayan_compatibility_report_v1',
  birth_day: 1,
  birth_month: 1,
  birth_year: 2000,
...
const basename = 'mayan-compatibility-report-sample';
...
writeFileSync(
  htmlPath,
  renderCompatibilityReportHtml(order, { coverImageUrl: `file:///${coverPath}` }),
  'utf8',
);
