      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-white border border-amber-200 rounded-lg p-6 md:p-8 mt-10 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <article className="rounded-lg bg-amber-50 border border-amber-100 p-5">
              <h3 className="font-bold text-gray-950 mb-2">Mayan sign compatibility</h3>
              <p className="text-gray-700">
                Compare the symbolic themes, strengths, and contrasts associated with two Nawals.
              </p>
            </article>
            <article className="rounded-lg bg-blue-50 border border-blue-100 p-5">
              <h3 className="font-bold text-gray-950 mb-2">Galactic Tone rhythm</h3>
              <p className="text-gray-700">
                See whether the two tones suggest a similar pace or a relationship shaped by contrast.
              </p>
            </article>
            <article className="rounded-lg bg-orange-50 border border-orange-100 p-5">
              <h3 className="font-bold text-gray-950 mb-2">Relationship reflection</h3>
              <p className="text-gray-700">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-10">
          <article className="bg-white border border-amber-100 rounded-lg p-6 shadow-sm">
            <h2 className="text-xl font-bold text-gray-950 mb-3">Calculate each birth chart</h2>
          ...
          <article className="bg-white border border-amber-100 rounded-lg p-6 shadow-sm">
            <h2 className="text-xl font-bold text-gray-950 mb-3">Explore the 20 day signs</h2>
            <p className="text-gray-700 mb-4">
          ...
          <article className="bg-white border border-amber-100 rounded-lg p-6 shadow-sm">
            <h2 className="text-xl font-bold text-gray-950 mb-3">Understand the 13 tones</h2>
            <p className="text-gray-700 mb-4">
