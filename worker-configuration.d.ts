/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.report-worker.jsonc` (hash: b604ba32e42e53fbda5adc3a4c11d27e)
...
interface __BaseEnv_Env {
	...
	REPORT_FROM_EMAIL: "Mayan Astrology Calculator <support@mayanastrologycalculator.com>";
	REPORT_REPLY_TO_EMAIL: "support@mayanastrologycalculator.com";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/report-fulfillment");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "REPORT_FROM_EMAIL" | "REPORT_REPLY_TO_EMAIL">> {}
}
